package com.whu.support.remind.service;

import com.whu.framework.common.page.PagingResult;
import com.whu.framework.common.persistence.CommonMybatisDAO;
import com.whu.framework.common.search.Search;
import com.whu.framework.util.DateUtil;
import com.whu.support.remind.dao.StartRemindDAO;
...
public class StartRemindService {
    ...
    @Autowired private StartRemindDAO startRemindDAO;
