package com.whu.framework.base.aspect;
...
public class ServiceAspect {
	 ...
	 * @throws Throwable
	 */
	@Around(value = "execution(public * com.whu..service.*Service.*(..))")
...
//	@Before(value = "execution(public * com.whu..service.*Service.*(..))")
//	public Object beforeServiceMethod(final JoinPoint jp) throws Throwable {
//		System.out.println("before");
//		return "";
//	}
//	
//	@After(value = "execution(public * com.whu..service.*Service.*(..))")
