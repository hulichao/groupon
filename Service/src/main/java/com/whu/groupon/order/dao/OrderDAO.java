package com.whu.groupon.order.dao;
...
import com.whu.groupon.order.entity.OrderDetail;
...
public class OrderDAO extends BaseMybatisDAO {
    ...
    private static final String ORDER_MAPPER_NAMESPACE = "com.whu.groupon.order.entity.OrderMapper";

    private static final String ORDERDETAIL_MAPPER_NAMESPACE = "com.whu.groupon.order.entity.OrderDetailMapper";
