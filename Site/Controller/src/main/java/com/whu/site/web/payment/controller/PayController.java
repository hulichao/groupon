package com.whu.site.web.payment.controller;

import com.whu.framework.common.Pair;
...
import com.whu.site.web.alipay.util.AlipayNotify;
import com.whu.site.web.base.objects.WebUser;
import com.whu.site.web.payment.Payment;
import com.whu.site.web.payment.PaymentFactory;
import com.whu.site.web.site.controller.BaseSiteController;
import com.whu.site.web.site.controller.order.OrderController;
...
public class PayController extends BaseSiteController {
    ...
    public String payReturn(HttpServletRequest request, Model model) throws Exception {
        //FIXME 构造适用于支付宝返回及货到付款返回的方法,此时不再需要com.whu.site.web.payment.impl.alipay.controller.AlipayController
        //1.参数从request中获取
