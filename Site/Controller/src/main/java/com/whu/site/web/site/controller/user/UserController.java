package com.whu.site.web.site.controller.user;

import com.google.code.kaptcha.Constants;
import com.whu.framework.util.EncryptionUtil;
import com.whu.framework.util.QRCodeUtil;
import com.whu.framework.util.RegexUtil;
import com.whu.framework.util.SMSUtil;
...
public class UserController extends BaseSiteController {
	...
	public @ResponseBody Map<String, Object> checkSMSCode(String mobilephone, String smsCode, HttpSession session) {
		Map<String, Object> jsonMap = new HashMap<>();
	...
	public @ResponseBody Map<String, Object> checkExistsUsername(String username) {
		Map<String, Object> jsonMap = new HashMap<>();
	...
	public @ResponseBody Map<String, Object> sendSMSCode(HttpSession session, String mobilephone, String action) {
	...
	public @ResponseBody Map<String, Object> checkLogin(HttpServletRequest request) {
		Map<String, Object> jsonMap = new HashMap<>();
