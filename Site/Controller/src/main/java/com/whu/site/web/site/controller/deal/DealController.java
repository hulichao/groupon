package com.whu.site.web.site.controller.deal;
...
import com.whu.groupon.deal.service.DealCategoryService;
...
public class DealController extends BaseSiteController {
	...
	@Autowired private OrderService orderService; // 订单服务
