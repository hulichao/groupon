package com.whu.site.web.base.controller;
...
import com.whu.framework.util.EmailUtil;
import com.whu.framework.util.EncryptionUtil;
import com.whu.framework.util.RegexUtil;
import com.whu.framework.util.SMSUtil;
import com.whu.framework.util.StringUtil;
import com.whu.framework.web.controller.BaseController;
...
public class FrontendBaseController extends BaseController {
	 ...
	 *            电话号码
	 * @param action
	 *            目的，如：register(注册)、retrievePwd(找回密码)等，详见：com.whu.framework.util.SMSUtil.ACTION_MAP
	 * @param sender
	 *            发送者，site、app等
	 *            
	 * @return
